...
var DataService = class _DataService {
  ...
  industries = [
    ...
    { id: "retail", label: "Retail", icon: "\u{1F6CD}", description: "Retail brand building and performance marketing" },
    { id: "healthcare", label: "Healthcare", icon: "\u{1F3E5}", description: "Sensitive and effective healthcare communication" },
    { id: "fmcg", label: "FMCG", icon: "\u{1F4E6}", description: "Fast-moving consumer goods campaigns" },
    { id: "hospitality", label: "Hospitality", icon: "\u{1F3E8}", description: "Hotel, resort and hospitality brand marketing" },
    { id: "government", label: "Government", icon: "\u{1F3DB}", description: "Government and public sector communication" },
    { id: "ngo", label: "NGO / NPO", icon: "\u{1F91D}", description: "Non-profit and social impact communication" },
    { id: "education", label: "Education", icon: "\u{1F393}", description: "Educational institution branding and marketing" },
    { id: "real-estate", label: "Real Estate", icon: "\u{1F3D7}", description: "Real estate lead generation and brand campaigns" },
    { id: "banking", label: "Banking & Finance", icon: "\u{1F3E6}", description: "Financial services brand and digital marketing" },
    { id: "services", label: "Services", icon: "\u{1F4BC}", description: "Professional services brand communication" }
  ];
  // Legacy compatibility — kept so any existing admin code referencing these doesn't break
  portfolioItems = this.projects.map((p) => ({
    id: p.id,
    title: p.title,
    category: p.industry.toLowerCase(),
    image: p.image,
    width: 2,
    height: 3,
    featured: p.featured ?? false
  }));
  categories = this.industries.map((i) => ({
    id: i.id,
    label: i.label,
    image: "",
    count: 0
...
//# sourceMappingURL=chunk-GJMBPRDX.js.map
