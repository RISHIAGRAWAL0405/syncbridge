...
function ProjectsComponent_div_18_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "td", 26)(22, "a", 34);
    \u0275\u0275element(23, "i", 35);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ProjectsComponent_div_18_tr_19_Template_button_click_26_listener() {
      const project_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind3(6, 25, project_r4.description || "", 0, 40), "", (project_r4.description || "").length > 40 ? "..." : "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(project_r4.client_name);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(project_r4.project_code || "\u2014");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(project_r4.start_date ? \u0275\u0275pipeBind2(14, 29, project_r4.start_date, "mediumDate") : "\u2014");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(project_r4.end_date ? \u0275\u0275pipeBind2(17, 32, project_r4.end_date, "mediumDate") : "\u2014");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(35, _c1, project_r4.project_id));
    \u0275\u0275advance(4);
...
function ProjectsComponent_div_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(19, ProjectsComponent_div_18_tr_19_Template, 28, 37, "tr", 27)(20, ProjectsComponent_div_18_tr_20_Template, 3, 0, "tr", 28);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function ProjectsComponent_div_20_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56)(1, "label", 51);
    \u0275\u0275text(2, "Client *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "select", 66)(4, "option", 67);
    \u0275\u0275text(5, "\u2014 Select Client \u2014");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, ProjectsComponent_div_20_div_9_option_6_Template, 2, 2, "option", 68);
    \u0275\u0275elementEnd();
...
function ProjectsComponent_div_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(6, ProjectsComponent_div_20_div_6_Template, 2, 1, "div", 46);
    ...
    \u0275\u0275template(9, ProjectsComponent_div_20_div_9_Template, 9, 3, "div", 49);
    ...
    \u0275\u0275text(15, "Required");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 54)(17, "label", 51);
    \u0275\u0275text(18, "Code");
    \u0275\u0275elementEnd();
    \u0275\u0275element(19, "input", 55);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 56)(21, "label", 51);
    \u0275\u0275text(22, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275element(23, "textarea", 57);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 58)(25, "label", 51);
    \u0275\u0275text(26, "Start Date");
    \u0275\u0275elementEnd();
    \u0275\u0275element(27, "input", 59);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "div", 58)(29, "label", 51);
    \u0275\u0275text(30, "End Date");
    \u0275\u0275elementEnd();
    \u0275\u0275element(31, "input", 60);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "div", 61)(33, "button", 62);
    ...
    \u0275\u0275template(36, ProjectsComponent_div_20_span_36_Template, 1, 0, "span", 64);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
var ProjectsComponent = class _ProjectsComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, ReactiveFormsModule, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, FormsModule, NgModel, RouterModule, RouterLink, SlicePipe, DatePipe], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ProjectsComponent, [{
    type: Component,
    args: [{ selector: "app-projects", standalone: true, imports: [CommonModule, ReactiveFormsModule, FormsModule, RouterModule], template: `<div class="page-header d-flex align-items-center justify-content-between mb-4">\r
  <div>\r
        ...
        <tbody>\r
          <tr *ngFor="let project of filteredProjects">\r
            ...
            <td class="text-end pe-4">\r
              <a class="btn btn-sm btn-outline-primary me-1" [routerLink]="['/admin/projects', project.project_id]" title="View project profile">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProjectsComponent, { className: "ProjectsComponent", filePath: "src/app/admin/projects/projects.component.ts", lineNumber: 16 });
})();
export {
  ProjectsComponent
};
//# sourceMappingURL=chunk-YWUXM23I.js.map
